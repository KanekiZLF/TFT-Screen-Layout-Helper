...
String textsLayoutFile = "/SD Files/Layout_Texts.JSON";
...
void setup() {
  ...
  if (sdIsInitialized) {
    ...
    drawLayoutFromJSON(textsLayoutFile.c_str()); // Chama a função para limpar a tela e desenhar todos os elementos do arquivo de layout.
  }
}
